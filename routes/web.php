...
/*
|--------------------------------------------------------------------------
| Rute yang memerlukan LOGIN (sisi pengguna)
|--------------------------------------------------------------------------
*/
...
/*
|--------------------------------------------------------------------------
| Rute Sisi Admin (wajib login + role admin)
|--------------------------------------------------------------------------
*/
...
Route::get('/reset-demo-sekali', function () {
    try {
        ...
        return "Database dibangun ulang dari nol. "
             . "Jumlah akun: {$akun} (seharusnya 2). "
             . "Jumlah tagihan: {$tagihan} (seharusnya 4). "
             . "Kalau angkanya benar, HAPUS route ini sekarang.";
    } catch (\Throwable $ex) {
